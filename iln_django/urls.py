...
from iln.views import index, introduction, bibliography, about, links, searchform, article_display, volumes, volume_display, illustrations

urlpatterns = patterns('iln.views',
